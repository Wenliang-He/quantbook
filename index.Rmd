...
If the download does not automatically start, click the link as highlighted in the graph below (if your windows is 64-bit, otherwise clink the one immediately above it). 

![](images/gitdownload_win.png) 


2. Mac Users

- download Git from [this link](https://git-scm.com/download/mac) 

If the download does not automatically start, click the link as highlighted in the graph below. 

![](images/gitdownload_mac.png) 
...
Raw code for the following contents can be found [here](_markdown.Rmd).
