...
`TODO`: add the first graph with red and gold colors from notes_20180403
...
`TODO`: add the graph by the end of the 1st page in notes_20180410.
...
`TODO`: add graph by the end of 2nd page in notes_20180410. 
