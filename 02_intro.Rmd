...
1. teaching, research, practicum (实践)
...
The plural form of **_statistic_** is **_statistics_**. So the study of statistics (统计量) is statistics (统计学).
